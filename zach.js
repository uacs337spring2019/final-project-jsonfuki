(function(){
	...
	let timer = null; //slideshow timer
	let datePointer = ""; //for POST
	...
	function callAjax(funct, mode, type){
		let url = "http://kozmotattoo.herokuapp.com:+process.env.PORT?mode="+mode; //heroku
	...
	function submitApp(){
		...
		callAjax(null, fetchOptions, "post")
	}
	...
	function showSlides(){
		let slides = document.getElementsByClassName("eachslide");
			...
			//timer = setTimeout(showSlides, 2500); //2.5 seconds
	}
